        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProposedActionsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsApplied = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIAdvice", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AIAdvice_Users_UserId",
                        column: x => x.UserId,
